...
namespace BentoLab.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KorisnikID,ImePrezime,Email,Lozinka,Uloga")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KorisnikID,ImePrezime,Email,Lozinka,Uloga")] Korisnik korisnik)
        {
